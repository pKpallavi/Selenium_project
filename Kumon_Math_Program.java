...
public class KumonMathProgram {
  ...
  public void testKumonMathProgram() throws Exception {
    ...
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (isElementPresent(By.linkText("Ages 3-5"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }

    driver.findElement(By.linkText("Ages 3-5")).click();
    assertEquals(driver.findElement(By.cssSelector("h5")).getText(), "Build your child’s math skills from an early age");
    ...
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (isElementPresent(By.linkText("Ages 6-12"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
    ...
    for (int second = 0;; second++) {
    	if (second >= 60) fail("timeout");
    	try { if (isElementPresent(By.linkText("Ages 13+"))) break; } catch (Exception e) {}
    	Thread.sleep(1000);
    }
